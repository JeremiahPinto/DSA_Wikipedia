...
public class MyCITS2200Project implements CITS2200Project
{
	...
	//A method that gets the center(s) of the graph using the helper method findE
	@Override
	...
	public String[][] getStronglyConnectedComponents() 
	{
		...
		String[][] re = new String[component.size()][sizeA];
		int countA = 0, countB;

		for( ArrayList<Integer> a : component )
		{
			countB = 0;

			for ( int i = 0; i < a.size(); i++ ) 
			{
				re[countA][countB] = page.getVertex(component.get(countA).get(countB));
				countB++;
			}
			countA++;
		}
